...
void LtePhyBase::initialize(int stage)
{
    ...
    if (stage == 0)
    {
        ...
        SINR_dl_ = registerSignal("SINR_dl");
        SINR_dlvect_ = registerSignal("SINR_dlvect");

        SINR_ul_ = registerSignal("SINR_ul");
       SINR_ulvect_ = registerSignal("SINR_ulvect");
