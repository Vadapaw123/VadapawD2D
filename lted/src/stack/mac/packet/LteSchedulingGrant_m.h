...
#ifndef _LTESCHEDULINGGRANT_M_H_
#define _LTESCHEDULINGGRANT_M_H_
...
/**
 * Class generated from <tt>src/stack/mac/packet/LteSchedulingGrant.msg:17</tt> by nedtool.
 * <pre>
 * //
 ...
 * </pre>
 */
class LteSchedulingGrant_Base : public ::cPacket
{
  protected:
    bool periodic_var;
    unsigned int period_var;
    unsigned int expiration_var;
    unsigned int totalGrantedBlocks_var;
    unsigned int codewords_var;
  ...
  protected:
    ...
    LteSchedulingGrant_Base(const char *name=NULL, int kind=0);
  ...
  public:
    ...
    virtual LteSchedulingGrant_Base *dup() const {throw cRuntimeError("You forgot to manually add a dup() function to class LteSchedulingGrant");}
...
#endif // ifndef _LTESCHEDULINGGRANT_M_H_
